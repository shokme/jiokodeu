<div class="bg-gray-50 min-h-screen flex items-center">
  <div class="sm:mx-auto sm:w-full sm:max-w-md">
    <div class="flex items-center justify-center w-full sm:mx-auto sm:w-full sm:max-w-md">
      <img class="inline h-12 w-auto" src="/img/logos/workflow-mark-on-white.svg" alt="Jiokodeu"/>
      <h2 class="ml-2 inline align-center text-center text-3xl leading-9 font-extrabold text-gray-900">
        Jiokodeu
      </h2>
    </div>
    <div class="mx-auto mt-10 bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
